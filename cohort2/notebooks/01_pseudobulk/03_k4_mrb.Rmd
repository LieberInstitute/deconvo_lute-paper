---
title: "Pseudobulk k4 with and without cell size rescaling, cohort2"
author: "Sean Maden"
date: "2023-10-10"
...
setwd("..")
setwd("..")
new.plot.name <- "figs1_mrb_k4.jpg"
jpeg(file.path("./figures/01_pseudobulk/", new.plot.name), 
     width = 4.5, height = 3, units = "in", res = 400)
new.plot
dev.off()
```
```
