...
```{r}
new.plot.facet <- new.plot.k2.noline + facet_grid(celltype~type)
new.plot.facet
new.plot.facet + ylim(0, 0.1) + xlim(0, 0.1)
```
...
jpeg("./figures/01_pseudobulk/fig2_pbmc-k2-result-withline_zooms.jpg", 
     width = 10, height = 2.8, units = "in", res = 400)
...
jpeg("./figures/01_pseudobulk/fig2_pbmc-k2-result_facet.jpg", 
     width = 7, height = 5.5, units = "in", res = 400)
new.plot.facet
dev.off()

jpeg("./figures/01_pseudobulk/fig2_pbmc-k2-result_facet-zoom.jpg", 
     width = 7, height = 5.5, units = "in", res = 400)
new.plot.facet + ylim(0, 0.1) + xlim(0, 0.1)
dev.off()
```
