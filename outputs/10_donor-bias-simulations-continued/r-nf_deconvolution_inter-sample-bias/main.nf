...
include { predict_proportions_lindex as predict_prop } from "$launchDir/modules/predict_proportions_lindex"
...
workflow {
    ...
    li_filepath = channel.fromList( params.list_index_filepath ) // indices matrix filepath
