...
```{r}
facet.variable.vector <- c("anatomic.region", "library.preparation.id", "cell.compartment.id")
...
```{r}
lapply(results.list.dfp4, function(results.list.iter){results.list.iter$heatmaps$heatmap6})
```
