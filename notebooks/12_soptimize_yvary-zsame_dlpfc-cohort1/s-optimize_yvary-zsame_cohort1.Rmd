...
## Get plot data for "sample-region-compartment-library"

Gets the first ID in the "sample-region-compartment-library" designation, saves as `dfp1`.

```{r}
variable.name <- "sample.labels"
id.to.get <- df.res[,variable.name][1]
filter.variable.vector <- df.res[,variable.name]==id.to.get
dfp1 <- df.res[filter.variable.vector,]
```
...
## Get plot data for "sample-compartment-library"
