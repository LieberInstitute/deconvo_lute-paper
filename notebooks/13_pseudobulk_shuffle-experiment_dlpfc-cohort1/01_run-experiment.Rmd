...
setwd("..")
setwd("..")
env.name <- "01_run-experiment.RData"
...
setwd("..")
setwd("..")
# list.files(file.path("deconvo_method-paper", "outputs"))
...
ggplot(dfp, aes(x = neuron.true, y = neuron.pred.nnls, color = sample.id)) + 
  ...
  xlim(0, 1) + ylim(0, 1) +
  facet_wrap(~s.matched) + ggtitle("Experiment 1")
```
...
ggplot(dfp, aes(x = neuron.true, y = neuron.pred.nnls, color = sample.id)) + 
  geom_point() + geom_abline(slope = 1, intercept = 0) +
  xlim(0, 1) + ylim(0, 1) +
  facet_wrap(~zs.matched) + ggtitle("Experiment 2")
```
...
ggplot(dfp, aes(x = neuron.true, y = neuron.pred.nnls, color = sample.id)) + 
  geom_point() + geom_abline(slope = 1, intercept = 0) +
  xlim(0, 1) + ylim(0, 1) +
  facet_wrap(~z.matched) + ggtitle("Experiment 3")
```
