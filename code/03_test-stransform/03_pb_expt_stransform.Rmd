...
Below, we use the following data as obtained from the paper (CITATION HERE).

```{r}
knitr::kable(data.frame(cell_type = c("Excit", "Inhib", "Oligo", "other")))
```
