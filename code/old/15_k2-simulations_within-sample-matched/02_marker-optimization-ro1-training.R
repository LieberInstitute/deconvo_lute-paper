...
# save
markers.by.batch.path <- here("deconvo_method-paper", 
                              "outputs", "list-markers-by-batch_dlpfc-ro1-train.rda")
save(markers.by.batch, file = markers.by.batch.path)

markers.overlaps <- get.overlapping.markers(markers.by.batch, NULL)
markers.overlaps.path <- here("deconvo_method-paper", 
                              "outputs", 
...
markers.filtered.path <- here("deconvo_method-paper", "outputs", 
...
sce.markers.path <- here("deconvo_method-paper", "outputs", sce.markers.name)
