...
```{r}
dfp <- data.frame(unadj = dfres[dfres$prop.type == "punadj",]$bias,
                  adj = dfres[dfres$prop.type == "padj",]$bias,
                  offset = dfres[dfres$prop.type == "punadj",]$offset,
                  type = dfres[dfres$prop.type == "punadj",]$type.index)
