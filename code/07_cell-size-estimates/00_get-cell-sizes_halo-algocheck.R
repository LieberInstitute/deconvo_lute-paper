...
if(!file.exists(lcsv.fpath)){
  fpath <- file.path(base.path, "Human_DLPFC_Deconvolution", 
                     "raw-data", "HALO", subdir.name)
...
# save 
save.fname <- paste0("dfcellsize-byslide_halo_",out.fnstem,".rda")
...
# make multiplot
plot.fname <- paste0("ggvp-agg-bytype_halo-cell-sizes_",out.fnstem,".jpg")
