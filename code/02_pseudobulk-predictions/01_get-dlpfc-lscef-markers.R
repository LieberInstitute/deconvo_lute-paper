...
#
# Gets k2, k3, and k4 marker sets from DLPFC Cohort1 snRNAseq data.
#
...
#---------------
# get save dpath
code.dname <- "02_pseudobulk-predictions"
...
#-----------------------------
# get only training set donors
#-----------------------------
dim(sce) # [1] 36601 77604

trainv <- c("Br2720", "Br6471", "Br8492", "Br2743", "Br3942", "Br6423", "Br8325")
sce.filt <- sce[["BrNum"]] %in% trainv
sce <- sce[,sce.filt]
