...
results1 <- simulation_results(s.list.square, z = z, scale.s = TRUE, 
                               experiment.type = results1.label)
# matched, no transform
results2 <- simulation_results(s.list.square, z = z, scale.s = FALSE, 
                               experiment.type = results2.label)
