...
Heatmaps subsetting on size category. All heatmaps use Z scaled expression.

## Large cell sizes

Heatmaps only showing markers from large cell size (cell types : 
`r unique(markerTable[markerTable$sizeCategory=="high",]$cellType)``).
...
Heatmaps only showing markers from medium cell size (cell types : 
`r unique(markerTable[markerTable$sizeCategory=="medium",]$cellType)``).
...
Heatmaps only showing markers from low cell size (cell types : 
`r unique(markerTable[markerTable$sizeCategory=="low",]$cellType)``).
