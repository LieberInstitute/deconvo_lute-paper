...
Experiment condition matrix for conditions evaluated. Data were summarized as 
median TPM by cell type for the ABIS-seq reference, but the scale log2(TPM+1) 
was used for analyses in the manuscript.
...
These heatmaps show the Z-rescaled expression either with or without cell size 
transformations. Annotations on rows and columns show the cell type, where row
annotations show the primary cell type for which the given gene is a marker.
...
```{r}
# save large heatmap image
setwd("..")
setwd("..")
jpeg("./figures/04_transform/heatmap_transform_tpm_filteredmarkers.jpg", 
...
setwd("..")
setwd("..")
jpeg("./figures/04_transform/heatmap_transform_tpmlog2plusone_filteredmarkers.jpg", 
     width = 10, height = 18, units = "in", res = 400)
heatmap1 + heatmap2
dev.off()
```
