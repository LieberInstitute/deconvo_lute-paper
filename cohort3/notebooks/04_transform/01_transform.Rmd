...
# Heatmaps before transformation

17 cell types from ABIS-seq reference.
...
# Heatmaps after transformation

# Heatmap grids showing before and after transformation, side by side

## Contrasting heatmaps

These heatmaps show the 
