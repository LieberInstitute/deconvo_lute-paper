...
new.plot.path <- file.path("figures", "03_shuffle", "fig3g.jpg")
...
colnames(dfp.tall.write)[10] <- "matched.id"
...
dfp.tall.write$shuffle.term <- "Z_pseudobulk"
...
setwd("..")
setwd("..")
write.csv(dfp.tall.write, row.names = F, file = "./outputs/03_shuffle/table_s3_zpseudobulk.csv")
```
