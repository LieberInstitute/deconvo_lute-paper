...
# save path
save.path <- here("deconvo_method-paper", "cohort1", "data", "outputs", "04_experiment")
...
sce.prepared.path <- file.path("deconvo_method-paper", "cohort1", "data", "outputs", "04_experiment", "sce-prepared_dlpfc-ro1-train.rda")
