...
`software_manuscript` includes additional files for the `lute` software vignettes and reporting RMSEs. `dann-et-al-2023_env` and `sosina-et-al-2021_env` include environment information from studies (7,8). 

Folders `huuki-meyers-et-al-2023_dlpfc-cohort1` (3,4), `tran-et-al-2021_dlpfc-cohort2` (5), and `monaco-et-al-2019_pbmc-cohort1` (6) include bulk and single-nucleus transcriptomics data from 3 sources including dorsolateral prefrontal cortex (DLPFC), and peripheral blood mononuclear cell (PBMC) data.
